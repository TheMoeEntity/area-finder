...
const Signup = () => {
    ...
    return (
        <div className='flex flex-col py-8 px-4 dark:bg-[#171717]'>
            ...
            <form onSubmit={e => Helpers.validateSignUpForm(e, setStatus, enqueueSnackbar, push, setError)} className='py-5 flex flex-col gap-y-5'>
                ...
                <div className=''>
                    <div className='w-full'>
                        <input placeholder="password" type="password" className={"py-4 dark:bg-[#242428] dark:placeholder:text-[white] dark:border-none rounded-md  bg-[#D4DCF1] placeholder:text-black px-3 w-full border-gray-300 border-[1px] text-sm " + (error ? ' border-red-500' : "border-[transparent]")} />
                    </div>
                    {error && (<span className='py-3 text-red-500'>passwords do not match</span>)}
                </div>
                <div className=''>
                    <div className='w-full'>
                        <input placeholder="confirm password" type="password" className={"py-4 dark:bg-[#242428] dark:placeholder:text-[white] dark:border-none rounded-md  bg-[#D4DCF1] placeholder:text-black px-3 w-full border-gray-300 border-[1px] text-sm " + (error ? ' border-red-500' : "border-[transparent]")} />
                    </div>
                    {error && (<span className='py-3 text-red-500'>passwords do not match</span>)}
                </div>
                <div>
